        ...
        <div class="bg-white border rounded-4 p-4 shadow-sm">
            ...
            <form>
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <textarea class="form-control" rows="4" placeholder="Describe the issue you need help with"></textarea>
                    </div>
                </div>

                <button type="button" class="btn mt-3" style="background:#D4AF37; font-weight:800;">
                    Submit Help Request
                </button>
            </form>
